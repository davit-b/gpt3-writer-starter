...
const basePrompt = `Give me the ingredients for SINGLE simple meal that mean the following criteria.
...
export default async function handler(req, res) {
  ...
  switch (method) {
    case "POST":
      const firstPrompt =
        `${basePrompt}${body.userInput}\nWrite a list of ingredients and their macronutrient breakdowns followed by writing a recipe to efficiently cook.\nMeal 4:\n`
      ...
      console.log("firstCompletion.data", firstCompletion.data)
      /* Looks like the following.
      firstCompletion.data {
      ...
      */
      ...
      // const secondPrompt =
      //   `${basePrompt}${body.userInput}\nMeal 4:\n${firstPromptOutput}\n Write a simple recipe to efficiently cook Meal X.`
      ...
      res.status(200).json({ firstOutput: firstPromptOutput, secondOutput: { text: "blank" } })
      break
    default:
